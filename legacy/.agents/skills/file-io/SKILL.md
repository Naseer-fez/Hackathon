...
name: file-io
description: >-
  Token-efficient file reading and writing patterns. Use this skill when
  performing any file operations to minimize context window usage and
  avoid reading/writing unnecessary content.
---
