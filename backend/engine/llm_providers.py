...
class UnavailableLlmProvider(BaseLlmProvider):
    ...
    async def generate_text(
        ...
        """Return truthful status that no AI model is available without fabricating data."""
        return "No LLM model is currently available. Please configure Cloud API credentials (GEMINI_API_KEY) or start a local AI runtime."
