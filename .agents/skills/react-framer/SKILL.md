...
name: react-framer
description: >-
  React and Framer Motion component patterns, animation templates,
  and UI conventions. Use when working with .tsx/.jsx files, React
  components, Framer Motion animations, or Next.js pages.
---
